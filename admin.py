...
def about():
    about_us_text = "This is a simple GUI application.\n\nDeveloped by: TEAM17\nVersion: 1.0"

    
    about_us_window = tkinter.Toplevel(root)
    about_us_window.title("About Us")

    
    style = ttk.Style()
    style.configure("TSeparator", background="#808080")

    
    about_us_label = ttk.Label(about_us_window, text=about_us_text, padding=(20, 20))
    about_us_label.pack()

  
    separator = ttk.Separator(about_us_window, orient="horizontal")
    separator.pack(fill="x", padx=20, pady=10)

    close_button = ttk.Button(about_us_window, text="Close", command=about_us_window.destroy)
